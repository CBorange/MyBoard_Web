...
public class UserService implements UserDetailsService {
    ...
    public UserNotification makeNotificationForComment(String senderId, String userId, String content, int contentId){
        UserNotification newNoti = new UserNotification();
        newNoti.setSenderId(senderId);
        newNoti.setUserId(userId);
        newNoti.setContent(UserNotiUtil.makeContentForComment(senderId, content));
    ...
    public UserNotification makeNotificationForSubComment(String senderId, String userId, String content, int contentId){
        UserNotification newNoti = new UserNotification();
        newNoti.setSenderId(senderId);
        newNoti.setUserId(userId);
        newNoti.setContent(UserNotiUtil.makeContentForSubComment(senderId, content));
        newNoti.setContentId(contentId);
        newNoti.setContentType("comment");
